import {
  ...
  sortName,
  sortType,
} from "@/store/filter/product/filter-product-type.ts";
...
export const getters = {
  GetFormFilterProduct: (s: { formFilterProduct: TypeFilterProduct }) =>
    s.formFilterProduct,
  GetMaxValue: (s: { formFilterProduct: TypeFilterProduct }) =>
    s.formFilterProduct.maxValue,
  GetMinValue: (s: { formFilterProduct: TypeFilterProduct }) =>
    s.formFilterProduct.minValue,
  GetSortName: (s: { formFilterProduct: TypeFilterProduct }) =>
    s.formFilterProduct.sortName,
  GetSortType: (s: { formFilterProduct: TypeFilterProduct }) =>
    s.formFilterProduct.sortType,
  GetSearch: (s: { formFilterProduct: TypeFilterProduct }) =>
    s.formFilterProduct.search,
  GetApplicabilitiesChecked: (s: { formFilterProduct: TypeFilterProduct }) =>
    s.formFilterProduct.applicabilitiesChecked,
  GetBrandChecked: (s: { formFilterProduct: TypeFilterProduct }) =>
    s.formFilterProduct.brandChecked,
  GetCategoriesChecked: (s: { formFilterProduct: TypeFilterProduct }) =>
